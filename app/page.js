  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 bg-cover bg-center text-xs md:text-base lg:text-lg">
        <div className="font-bold flex gap:6 md:gap-20 md:text-5xl justify-center items-center text-3xl ">Buy Me a Chai <span><Image className="invertImg" src="/tea.gif" width={88} alt="" /></span></div>
      ...
      <div className="text-white container mx-auto pb-32 pt-14">
        ...
        <div className="flex gap-5 justify-around">
          <div className="item space-y-3 flex flex-col justify-center items-center">
            <Image className="bg-slate-400 rounded-full p-2 text-black" width={88} src="/man.png" alt="" />
